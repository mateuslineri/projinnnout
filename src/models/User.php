...
class User extends Model {
    ...
    public function validate() {
        ...
        if (!$this->confirm_password) {
            $errors['confirm_password'] = 'A confirmação da senha é obrigatória';
        } 
        ...
        if (!$this->start_date) {
            ...
            $errors['start_date'] = 'A data de admissão deve estar no formato dd/mm/aaaa';
        }

        if ($this->end_date 
            && !DateTime::createFromFormat('Y-m-d', $this->end_date)) {
                $errors['end_date'] = 'A data de desligamento deve estar no formato dd/mm/aaaa';
        }
